...
public class Quest11 {
    public static void main(String[] args) {
        ...
        KWh=(potWatts*horas)/1000; //Dividir por 1000 é importante porque recebos o valor em Watts e o calculo é feito em KiloWatts 

        valorGasto = KWh * valorKWh;

        System.out.printf("O gasto de energia do equipanto é de %.2f KWh\n", KWh);
